...
<a class="btn btn-sm btn-danger" style="border-radius:0px;margin-top:2%" href="collections/'.$x.'"> Reset Filter</a>';
		...
		<div class="col-12 text-md-left text-center" style="display: block">
			...
			if($y == ''){
				...
				echo '<a id="learnMoreBtn" class="btn btn-md" href="collections/'.$x.'/'.$product_brand.'" style="border:1px solid gray;margin:0.5%;padding:0.5%;font-size:small;border-radius:0px;width:90px">'.$product_brand.'</a>';
				}
			}else{
				echo '<a id="learnMoreBtn" class="btn btn-md" href="collections/'.$x.'" style="border:1px solid gray;margin:0.5%;padding:0.5%;font-size:small;border-radius:0px">Show All Brands</a>';
			}
			?>
		</div>
	</div>
