...
<div class="row">
<p  class="col-lg-12 col-md-12 col-sm-12 mt-12" style="font-size: 40px;color:#7d7f82">Softwares & Firmwares</p><br>
	<div class="col-lg-12 col-md-3 col-sm-6 mt-3" style="background-color: transparent;border-radius: 5px;padding:0.5% !important">
		...
		<?php
		$sql  = "SELECT * FROM `tbl_partner_items` WHERE `item_type` = '2' AND `item_status` = '1' ORDER BY `item_name` ASC";
		$result = mysqli_query($dbcon,$sql) or die ('error 404');
            ...
            $ext = $item_file;    
            echo $ext = substr($ext, strpos($ext, ".") + 1);    
