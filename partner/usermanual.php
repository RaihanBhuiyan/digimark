...
<div class="row">
<p  class="col-lg-12 col-md-12 col-sm-12 mt-12" style="font-size: 40px;color:#7d7f82">User Manuals</p><br>
	<div class="col-lg-12 col-md-3 col-sm-6 mt-3" style="background-color: transparent;border-radius: 5px;padding:0.5% !important">
		...
		<?php
		$sql  = "SELECT * FROM `tbl_partner_items` WHERE `item_type` = '3' AND `item_status` = '1' ORDER BY `item_name` ASC";
