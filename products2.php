...
<a class="btn btn-sm btn-danger" style="border-radius:0px;margin-top:2%" href="collections/'.$x.'"> Reset Filter</a>';
		...
		<div class="col-12 text-md-left text-center" style="display: block">
			...
			if($y == ''){
				...
				echo '<a id="learnMoreBtn" class="btn btn-md" href="collections_jmf/'.$x.'/'.$product_brand.'" style="border:1px solid gray;margin:0.5%;padding:0.5%;font-size:small;border-radius:0px;width:90px">'.$product_brand.'</a>';
				}
			}else{
				echo '<a id="learnMoreBtn" class="btn btn-md" href="collections_jmf/'.$x.'" style="border:1px solid gray;margin:0.5%;padding:0.5%;font-size:small;border-radius:0px">Show All Brands</a>';
			}
			?>
		</div>
	</div>
...
//alert(output+'-'+category+'-'+brand+'-'+showCount+'-'+showSort+'-'+showPage+'-'+priceRange);
	...
	$.ajax({
		      type:"post",
		      url:"ajaxProductDisplayTest2.php",
