           ...
           <ul class="navbar-nav ml-auto" style="margin-right: 4.90vw">
             <!--<ul class="navbar-nav ml-auto" style="margin-right: 6.25%">-->
				...
				<li class="nav-item dropdown">
                    ...
                    <li><a class="dropdown-item" href="mission-and-vision">Mission & Vision</a></li>
                    <li><a class="dropdown-item" href="awards">Awards</a></li>
                    <li><a class="dropdown-item" href="why-digimark-solution">Why Us</a></li>
                    <li><a class="dropdown-item" href="team-digimark">Our Team</a></li>
                    <li><a class="dropdown-item" href="office-environment">Office Environment</a></li>
                    <!--<li><a class="dropdown-item" href="products-&-solutions">Products & Solutions</a></li>-->
                    </ul>
                </li>
                ...
                $result1 = mysqli_query($dbcon,$sql1) or die ('error 404');
                        while($row1 = mysqli_fetch_assoc($result1)){
                            ...
                            echo '<li><a class="dropdown-item" href="collections_jmf/'.$cat_url.'">'.ucfirst($cat_name).'</a></li>';
                ...
                //                         <a class="dropdown-item dropdown-toggle" href="collections/'.$cat_url.'" id="navbarDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">'.$cat_name.'</a>
                //                             <ul class="dropdown-menu" id="sub2" aria-labelledby="navbarDropdown1">';
                //                                  echo '<li><a class="dropdown-item" href="collections/'.$cat_url.'">All Brands</a></li>';
                // $sql2 = "SELECT DISTINCT `tbl_brand`.`brand_name` AS `brand_name`,`tbl_brand`.`brand_url` AS `brand_url` FROM `tbl_product` LEFT JOIN `tbl_brand` ON `tbl_product`.`product_brand` = `tbl_brand`.`brand_code` WHERE `tbl_product`.`product_category` = '$cat_code' AND `tbl_brand`.`brand_status` = '1'";
                // $result2 = mysqli_query($dbcon,$sql2) or die ('error 404');
                //         while($row2 = mysqli_fetch_assoc($result2)){
                //             $brand_name = $row2['brand_name'];
                //             $brand_url = $row2['brand_url'];
                //                             echo '<li><a class="dropdown-item" href="collections/'.$cat_url.'/'.$brand_url.'">'.$brand_name.'</a></li>';
                //         }       
                ...
                <li class="nav-item dropdown">
                    ...
                    $result2 = mysqli_query($dbcon,$sql2) or die ('error 404');
                            while($row2 = mysqli_fetch_assoc($result2)){
                                ...
                                echo '<li><a class="dropdown-item" href="'.$menuUrl.'">'.$menuName.'</a></li>';
                            }
                        ?>
                    </ul>
                </li>
...
<div id="overlay" style="display: none;">
    ...
    <h1 style="color:#ffffff">Search...</h1>
