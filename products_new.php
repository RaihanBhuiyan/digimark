  	...
  	<div class="col-12" style="box-shadow: 0px 0px 5px rgba(0,0,0,0.2);">
	    <div class="row row-product-inner-top">
			<div class="col-md-6 col-sm-12 text-md-left text-center" style="width:100%;margin: 0px !important">
					...
					<a style="color:#f16724;text-decoration:none" href="collections/<?php echo $litePath[2];?>?item=16&range=%2C&sort=ASC"><?php echo ucfirst($litePath[2]).'</a>';
					if($litePath[3] !== null){
...
<div class="col-12">
	<div class="row row-product-inner-bottom" style="">
		<div class="col-lg-2 col-md-3 col-sm-12 col-12" style="box-shadow: 0px 0px 5px rgba(0,0,0,0.2);background-color: transparent;padding: 0.5% !important;padding-top: 1.5% !important;">
			<div style="width: 100%;">
				<h5 class="float-left" style="margin-top: 2%">Filters </h5>
				<button class="btn btn-default d-block d-md-none float-right" onclick="filter_show()"><i class="fas fa-filter"></i></button>
			</div>
			<div class="clearfix"></div>
			<div id="filter-box" class="d-none d-md-block" style="width: 100%;">
				<div>
				  <label for="amount"><b>Price range:</b></label><br>
				  <input type="text" id="priceFrom" onkeyup="make_filter(1)" placeholder="Min" style="border:1px solid gray; color:#f6931f; font-weight:bold;width: 40%">
				  <label>To</label>
				  <input type="text" id="priceTo" onkeyup="make_filter(1)" placeholder="Max" style="border:1px solid gray; color:#f6931f; font-weight:bold;width: 40%">
				</div>
		...
		<div class="col-12 text-md-left text-center" style="display: block">
			...
			if($y == ''){
				...
				echo '<a class="btn btn-md" href="collections/'.$x.'/'.$product_brand.'" style="background-color:#4c4d4f;color:#ffffff;border-radius:0px; margin:0.5% !important;font-size:14px !important">'.$product_brand.'</a>';
				}
			}else{
				echo '<a class="btn btn-md" href="collections/'.$x.'" style="background-color:#4c4d4f;color:#ffffff;border-radius:0px; margin:0.5% !important;font-size:14px !important">Show All Brands</a>';
			}
			?>
		</div>
	</div>
...
<div class="col-12" style="box-shadow: 0px 0px 5px rgba(0,0,0,0.2);">
	<?php
			...
			echo '<h3 style="padding-top:1%">About '.$category_name.'</h3>';
