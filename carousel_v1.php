        ...
        if($i==0)
          { echo '
            <div class="carousel-item active">
              ...
              <div class="hero">
                <hgroup>
                  <div class="row row-carousel-inner">
                    <div class="'.$colValOne.' animated zoomInLeft slide-delay-4">';
                      if($itemTypeOne=='img'){
                        ...
                        echo '<h1 class="WhiteText">'.$itemOneOne.'</h1>
                        <div class="animated bounceInLeft slide-delay-2">
                        <h3 class="WhiteText">'.$itemOneTwo.'</h3>
                        </div>';
                      }
                    echo '</div>
                    <div class="'.$colValTwo.' animated slideInRight slide-delay-4">';
                        if($itemTypeTwo=='img'){
                        ...
                        echo '<h1 class="WhiteText">'.$itemTwoOne.'</h1>
                        <div class="animated bounceInLeft slide-delay-2">
              ...
              <img class="d-block w-100" draggable="false"  src="assets/images/carousel/'.$image.'" alt="'.$image.'">
              <div class="hero">
                <hgroup>
                  <div class="row row-carousel-inner">
                    <div class="'.$colValOne.' animated zoomInLeft slide-delay-1">';
                      if($itemTypeOne=='img'){
                        echo '<img class="img img-responsive" draggable="false"  src="assets/images/subcarousel/'.$itemOneOne.'" alt="'.$itemOneOne.'" style="max-width:100%">';
                      }else{
                        echo '<h1 class="WhiteText">'.$itemOneOne.'</h1>
                    ...
                    echo '</div>
                    <div class="'.$colValTwo.' animated slideInRight slide-delay-1">';
                        if($itemTypeTwo=='img'){
                        echo '<img class="img img-responsive" draggable="false"  src="assets/images/subcarousel/'.$itemTwoOne.'" alt="'.$itemTwoOne.'" style="max-width:100%">';
                        }else{
                        echo '<h1 class="WhiteText">'.$itemTwoOne.'</h1>
