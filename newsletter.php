...
<div class="" style="margin-left:5% !important;">
	<h1 class="heading" style="color: #ffffff"><b>Press Release</b></h1>
</div>
</div>
...
<div class="row" style="margin-bottom: 0.5%;margin-top: 0.5%;margin-left:5% !important;margin-right:5% !important;">
	<!--<div class="" style="padding: 0.5%">-->
		<div class="col-12">
			<div class="row">
<?php 
		    $sql  = "SELECT * FROM `tbl_newsletter` WHERE `status` IN('1','2')";
            ...
            //                     <img src="assets/images/newsletter/'.$news_image.'" alt="No Image" style="width:100% !important">
                                
            //                     <h3 class="top-story-title">'.$news_title_sub.'</h3>
            //                     <a class="btn btn-dark btn-sm" href="'.$news_link.'" style="border-radius:0px;margin-top: auto;" target="blank">View <i class="fas fa-arrow-circle-right"></i></a>
            //                     </div>
            //                 </div>';
             ...
             echo '<div class="col-lg-3 col-md-6 col-sm-6 col-12" style="text-align:center;padding:5px !important;" itemscope itemtype="https://schema.org/Article">
                                <a class="box-hover" href="'.$news_link.'" target="blank"><div class="item-container">
                                <img src="assets/images/newsletter/'.$news_image.'"  alt="No Image"  style="width:100% !important">
