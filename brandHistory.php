...
<h1 class="heading" style="color:#ffffff;box-shadow: 0px 0px 3px rgba(0,0,0,0.2);padding:3%;font-size:4vh !important"><b>Brand Story</b></h1>
</div>
</div>
...
<?php
$sql  = "SELECT * FROM `tbl_about_section` WHERE `about_code` = 'PG0001' AND `about_status` = '1'";
