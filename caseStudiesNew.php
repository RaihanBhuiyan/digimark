...
if($item == 'all' || $item == ''){
    ...
    $get_url = urldecode($litePath[2]);
    			$sql  = "SELECT * FROM `tbl_case_study` WHERE `url`='$get_url' AND `status` IN('1','2')";
...
<div class="row row-article" style="margin:0px">
	<div class="" style="margin-left:5% !important;">
		<h1 class="heading" style="color: #ffffff"><b>Case Studies</b></h1>
	</div>
</div>
<div class="row" style="margin-top: 0.5%;margin-bottom: 0.5%;margin-left:5% !important;margin-right:5% !important;">
	<!--<div class="" style="padding: 0.5%">-->
		<div class="col-12">
			...
			$cs_title = $row['title'];
			$cs_url = $row['url'];
            $cs_title_sub = substr($cs_title, 0, 200);
			$cs_details = $row['details'];
			$cs_crDate = $row['crDate'];
			...
			$cs_status = $row['status'];
                        ...
                        echo    
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12" style="text-align:center;padding:5px !important;" itemscope itemtype="https://schema.org/Article">
                                <a class="box-hover" href="case-study/'.$cs_url.'"><div class="item-container">
                                ...
                                <h5 class="top-story-title" style="margin-top:2.5%"><span style="color:#f16724">Published On : </span><span itemprop="dateCreated">'.date("d-m-Y", strtotime($cs_crDate)).'<span></h5><br>
                                <h3 class="top-story-title" style="margin-top:2.5%">'.$cs_title_sub.'</h3>
...
<h7 style="color: #ffffff"><a href="Case-Study">All Case Studies</a> / <?php echo $title;?></h7>
</div>
</div>
