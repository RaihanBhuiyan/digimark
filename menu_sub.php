             ...
             <!--<ul class="navbar-nav ml-auto" style="margin-right: 6.25%">-->
                ...
                $result1 = mysqli_query($dbcon,$sql1) or die ('error 404');
                  ...
                  echo '<li class="nav-item dropdown">
                        <a class="dropdown-item dropdown-toggle d-none d-md-block" id="navbarDropdown'.$i.'" data-url="'.$cat_url.'" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:pink !important">'.$cat_name.'</a>

                        <a class="dropdown-item dropdown-toggle d-sm-none" id="navbarDropdown'.$i.'" data-url="'.$cat_url.'" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:red !important">'.$cat_name.'</a>
