  ...
  <nav id="sidebar" class="sidebar-wrapper">
    <div class="sidebar-content">
      ...
      <!-- <div class="sidebar-header">
        <div class="user-pic">
          <img class="img-responsive img-rounded" src="https://raw.githubusercontent.com/azouaoui-med/pro-sidebar-template/gh-pages/src/img/user.jpg" style="height: auto !important" 
            alt="User picture">
        </div>
        <div class="user-info">
          ...
          <span class="user-role"><?php echo ucfirst($_SESSION['userDesignation']);?></span>
        ...
        <ul>
          ...
          <li class="sidebar-dropdown">
            ...
            <div class="sidebar-submenu">
              <ul>
                <li>
                  <a href="Manage-Pending-Dealer"><i class="fa fa-users"></i> Pending List</a>
                </li>
                <li>
