      ...
      <div class="sidebar-menu">
        ...
        if($_SESSION['userDesignation'] == 'Super Admin'){
          ...
          ?>
                  ...
                  <?php
                    $i = 0;$type_str = '';
                    $sql = "SELECT * FROM `table_permission` JOIN `master_menu` ON `table_permission`.`pageCode` = `master_menu`.`pageCode` WHERE `table_permission`.`userCode` = '$userCode'  ORDER BY `master_menu`.`type`";
