			...
			$blog_status = $row['status'];
                        ...
                        echo    
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12" style="text-align:center;padding:5px !important;" itemscope itemtype="https://schema.org/Article">
                                <a class="box-hover" href="blog/'.$blog_url.'"><div class="item-container">
...
<h7 style="color: #ffffff"><a href="Blog">All Blogs</a> / <?php echo $title;?></h7>
</div>
</div>
...
<div class="row" style="margin-bottom: 2.5%;">
  <div class="col-md-8 col-12" style="text-align: left;">
    ...
    <label style="background-color: #000000;color:white;text-align: left;padding: 1%;width: 100%"><b>Comments</b></label>
    <form action="Post-Comment" method="post">
                  <!-- <label style="color:#f16724;font-weight: bold;font-size: 20px">Write a review</label> -->
<div class="row">
  <input type="text" name="section" value="Blog" style="display:none">
  <input type="text" name="url" value="<?php echo $get_url;?>" style="display:none">
  <input type="text" name="article_code" value="<?php echo $code;?>" style="display:none">


  <div class="col-md-12 col-sm-12 col-xs-12 mt-3">
    <textarea spellcheck="true" id="review" class="form-control" name="comment"  placeholder="Write a review*" ></textarea>
  </div>
  ...
  <div class="col-md-12 col-sm-12 col-xs-12 mt-3 float-right">
    ...
    <button class="btn btn-sm btn-success float-right" type="submit" name="submit" id="btnRevCaptcha" disabled="true"  style="margin-top:1%"><i class="fas fa-comment"> </i> Post Comment</button>
    ...
    <label style="background-color: #000000;color:white;text-align: left;padding: 1%;width: 100%;margin-top:2.5%"><b>Recent Comments</b></label>
                <?php
            ...
            $result = mysqli_query($dbcon,$sql) or die ('error 404');
              ...
              <div class="row" style="border-bottom:0px solid lightgray;margin-bottom:0.5%;margin-top:0.5%" itemprop="itemReviewed" itemtype="https://schema.org/itemReviewed" itemscope>
                    ...
                    <div class="col-12 card-body" style="">
                      ...
                      <label itemprop="author" style="font-weight:bold !importamt;color:#ef6624">'.$name.'</label><br>
...
<div class="col-12 d-md-none" style="text-align:center;padding:2%;"><a href="#" id="loadS">Load More</a>
</div>
<div class="col-md-4 col-12" style="text-align: left;">
  <label style="background-color: #000000;color:white;text-align: left;padding: 2%;width: 100%;margin-top:0%"><b>Also Read</b></label>
      <?php 
        $sql  = "SELECT * FROM `tbl_blog` WHERE `status` IN('1','2')";
      $result = mysqli_query($dbcon,$sql) or die ('error 404z');
      while($row = mysqli_fetch_assoc($result)){
      ...
      $blog_status = $row['status'];
                        ...
                        echo    
                            '
                            <div class="col-12" style="text-align:center;padding-top:1.5% !important;padding-left:0px !important;padding-right:0px !important;" itemscope itemtype="https://schema.org/Article">
                                <a class="box-hover" href="Blog/'.$blog_url.'">
...
<div class="col-12 d-none d-md-block" style="text-align:center;padding:2%;"><a href="#" id="loadB">Load More</a></div>
</div>
...
<script type="text/javascript">
  ...
  <style>
    .pr_box{display:none;}
    #loadS,#loadB{background-color:#ef6624 !important; color:#ffffff !important;font-weight:bold;padding:1% !important;margin:2% !important;}
</style>
<script>
$(function(){
...
$(function(){
    $(".pr_box").slice(0, 5).show(); // select the first ten
    $("#loadB").click(function(e){ // click event for load more
        e.preventDefault();
        if($(".pr_box:hidden").length == 0){ // check if any hidden divs still exist
            alert("No item to display"); // alert if there are none left
        }else{
