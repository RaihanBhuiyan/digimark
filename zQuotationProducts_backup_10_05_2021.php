  	...
  	<div class="col-12" style="box-shadow: 0px 0px 5px rgba(0,0,0,0.2);">
	    <div class="row row-product-inner-top">
			<div class="col-md-6 col-sm-12 text-md-left text-center" style="width:100%;margin: 0px !important">
					...
					<a id="category" style="color:#f16724;text-decoration:none" href="qcollections/<?php echo $litePath[2];?>?item=16&range=%2C&sort=ASC"><?php echo ucfirst($litePath[2]).'</a>';
					if($litePath[3] !== null){
...
<a class="btn btn-sm btn-danger" style="border-radius:0px;margin-top:2%" href="collections/'.$x.'"> Reset Filter</a>';
		...
		<div class="col-12 text-md-left text-center" style="display: block">
			...
			if($y == ''){
				...
				echo '<a id="learnMoreBtn" class="btn btn-md" href="qcollections/'.$x.'/'.$product_brand.'" style="border:1px solid gray;margin:0.5%;padding:0.5%;font-size:small;border-radius:0px;width:90px">'.$product_brand.'</a>';
				}
			}else{
				echo '<a id="learnMoreBtn" class="btn btn-md" href="qcollections/'.$x.'" style="border:1px solid gray;margin:0.5%;padding:0.5%;font-size:small;border-radius:0px">Show All Brands</a>';
			}
			?>
		</div>
	</div>
